...
*/
ob_start();
$API_KEY = "2004119222:AAFtCOwRfTxqZY2P6swOUScTLVBZApUGwGs";//توكنك
$buy = "@kimo1157i";// معرفك
$sudo = "781195670";//ايديك
$admin = "$sudo";// ماتغير شي
$idBot = "2004119222";// ايدي بوتك
$admmm = $sudo;//ماتغير شي
$Dev = array("$sudo", "" );
$userrr = "tgreabhbot";// معرف بوتك بدون @
...
if($text =="السورس" || $text =="سورس"){
	...
	'chat_id'=>$chat_id,
	'text'=>"*┄─┅══┅─┄     
👋│اهلا بك في سورس كيمو ⚜
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
📡╿*[قناة السورس العامة](t.me/Source_kimo)*
👨🏻‍✈️╽*[مطور السـورس](t.me/kimo1157)*
●ـ▬ــ▬ஜ۩۞۩ஜ▬ـ▬ـ●
*",
    'disable_web_page_preview'=>true,
    'parse_mode'=>"MARKDOWN",
...
📬┊ معرف المطور » $buy
🖲┊[للمزيد اضغط هنا](t.me/Source_kimo)",
'parse_mode'=>"markdown",
'disable_web_page_preview'=>true,
        'reply_to_message_id'=>$message->message_id,
        'reply_markup'=>json_encode([
...
'disable_web_page_preview'=>true,
        ...
        'reply_markup'=>json_encode([
          'inline_keyboard'=>[  
                [['text'=>'- تابع قناة السورس ✅','url'=>'https://t.me/thtss']],
               ]
        ])
    ]);
}
...
'text'=>"
*🎭¦ مرحبا بك عزيزي $name ،
🔘¦ تم الإنتهاء عن البحث عن التطبيق ، 
